...
export function ConfirmDetailsModal({
  ...
  return (
    <View className="absolute inset-0 z-50 justify-center items-center bg-black/50 px-5">
      ...
      {showFullImage && !isPdf && imageUri && (
        <View className="absolute inset-0 z-50 bg-black/95 justify-between items-center p-5">
